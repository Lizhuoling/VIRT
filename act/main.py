...
def eval_bc(cfg, ckpt_path, save_episode=True):
    ...
    if cfg['TASK_NAME'] in ['isaac_singlebox', 'isaac_singlecolorbox', 'isaac_multicolorbox']:
        from act.utils.inference.isaac_manipulation import IsaacManipulationTestEnviManager
        envi_manager = IsaacManipulationTestEnviManager(cfg, policy, stats)
    elif cfg['TASK_NAME'] in ['aloha_singleobjgrasp', 'aloha_beverage', 'aloha_pourblueplate', 'aloha_openlid', 'aloha_pourblueberry', 'aloha_cleantable']:
        from act.utils.inference.aloha_manipulation import AlohaManipulationTestEnviManager
        envi_manager = AlohaManipulationTestEnviManager(cfg, policy, stats)
    else:
        raise NotImplementedError
...
if __name__ == '__main__':
    ...
    from utils.models.CNNMLP_policy import CNNMLPPolicy
    from utils.models.Diffusion_policy import DiffusionPolicy
