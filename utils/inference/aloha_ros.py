...
# Before instantialize RosOperator, first follow the following steps to start ros:
#   1. roscore # Start the ros system.
#   2. bash ./can.sh  # Check whether the communication is OK.
#   2. bash tools/puppet.sh # Run this command in /home/agilex/cobot_magic/remote_control/ on the robo to start the puppet. (follower 1: right, follower 2: left)
